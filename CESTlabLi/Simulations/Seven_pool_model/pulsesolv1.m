...
[a,b] = ode45(@f, tspan, y0);
    ...
    dydt = [ ((-sep1 - dw)*y(2) - (R2S1 + ksw1)*y(1) + mnots1/mnotw*ksw1*y(4))
             ...
             (dw*y(4) + w1*y(6)-R2W*y(5) + ksw1*y(2) - mnots1/mnotw*ksw1 *y(5)+ ksw2*y(9) - mnots2/mnotw*ksw2 *y(5)+ ksw3*y(12) - mnots3/mnotw*ksw3 *y(5)+ ksw4*y(15) - mnots4/mnotw*ksw4 *y(5)+ ksw5*y(18) - mnots5/mnotw*ksw5 *y(5))
